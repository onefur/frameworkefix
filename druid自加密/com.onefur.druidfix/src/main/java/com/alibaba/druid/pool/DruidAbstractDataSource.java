...
public abstract class DruidAbstractDataSource extends WrapperAdapter implements DruidAbstractDataSourceMBean, DataSource, DataSourceProxy, Serializable {
    ...
    //==========================================Add custom decryption method by yanglei===================================================================
    ...
    private static String GetKey(){
    	 try {
			 ...
			 File file = new File(basePath+File.separator+"conf"+File.separator+"magic.properties");
	    	 if(file.exists()){
				 ...
				 Object obj = config.get("magicKey");
				 if (obj == null) {
					 return null;
				 } else {
	    		 ...
	    		 LOG.info("Magic properties does not exist, to enable the default configuration");
	    		 return null;
	    	 }
			 
		} catch (Exception e) {
			LOG.info("Access to magic. The properties of failure, to enable the default configuration");
			return null;
		}
    }
    
    public void setPassword(String password) {
    	//Add the secret check by yanglei
    	System.out.println("Add the secret check by yanglei:凸-_-凸");
